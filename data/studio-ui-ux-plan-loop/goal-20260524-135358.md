# Studio UI/UX iteration — todo `studio-ux-00-design-system`
...
4. Run `./scripts/studio-ui-ux-capture-progress.sh` with `STUDIO_UI_UX_ITERATION=studio-ux-00-design-system`.
...
- Update plan YAML status for `studio-ux-00-design-system` when done.
