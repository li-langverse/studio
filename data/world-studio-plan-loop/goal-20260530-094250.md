# World Studio master plan iteration — todo `wsm-w3-mcp-dispatch`
...
```
4. Update plan YAML: set `wsm-w3-mcp-dispatch` status to `done` when gates green and slice complete.
