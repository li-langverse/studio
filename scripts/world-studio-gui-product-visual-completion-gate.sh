#!/usr/bin/env bash
# Exit 0 only when all wsv-w* todos done, gates pass, product-visual PNGs meet heuristics.
set -euo pipefail
...
PLAN="$ROOT/docs/superpowers/plans/2026-06-02-world-studio-gui-product-visual-loop.md"
PNG_DIR="$ROOT/docs/demo/media/native-verticals/png"
MANIFEST="$ROOT/data/world-studio-gui-product-visual-loop/latest-screenshots.json"
...
print("world-studio-gui-product-visual completion gate: all wsv-w* done + product-visual PNGs pass heuristics")
PY
