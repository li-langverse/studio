...
# Fast gate: dev stride 50 → 101 DFT calls @ 5000 steps
unset REAL_AIMD
...
if calls != 101:
    raise SystemExit(f"fast gate trace dft_calls={calls} expected 101 @ stride 50 / 5000 steps")
print("W8 fast gate: dft_stride=50 dft_calls=101 OK")
PY
